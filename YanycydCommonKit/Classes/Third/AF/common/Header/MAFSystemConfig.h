...
//  MAF
//
//  Created by victor on 14-3-24.
//  Copyright (c) 2014年 ctnq. All rights reserved.
//

#ifndef MAF_MAFSystemConfig_h
#define MAF_MAFSystemConfig_h
...
//NSString *result1 = [[NSString alloc] initWithData:registerInformation  encoding:NSUTF8StringEncoding];
